...
public class CustomLitEditor : BaseShaderGUI
{
    private CustomLitGUI.LitProperties litProperties;

    private bool m_AddtionalFoldout = true;

    // [SerializeField] private float _MinDistanceDissolve = 1f;
    // [SerializeField] private float _MaxDistanceDissolve = 2f;
    ...
    //     {
    //         _MinDistanceDissolve = EditorGUILayout.FloatField("_MinDistanceDissolve", _MinDistanceDissolve);
    //         _MaxDistanceDissolve = EditorGUILayout.FloatField("_MaxDistanceDissolve", _MaxDistanceDissolve);
    //     }
    //
    ...
    public override void MaterialChanged(Material material)
    {
        ...
        SetMaterialKeywords(material, CustomLitGUI.SetMaterialKeywords);
    }
