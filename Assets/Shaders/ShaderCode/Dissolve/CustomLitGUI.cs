...
{
    [MovedFrom("UnityEditor.Rendering.LWRP.ShaderGUI")] public static class CustomLitGUI
    {
        ...
        {
            public MaterialProperty _MinDistanceDissolve;
            public MaterialProperty _MaxDistanceDissolve;
            ...
            {
                _MinDistanceDissolve = CustomBaseShaderGUI.FindProperty("_MinDistanceDissolve", properties, true);
                _MaxDistanceDissolve = CustomBaseShaderGUI.FindProperty("_MaxDistanceDissolve", properties, true);

            // Surface Option Props
                workflowMode = CustomBaseShaderGUI.FindProperty("_WorkflowMode", properties, false);
                // Surface Input Props
                metallic = CustomBaseShaderGUI.FindProperty("_Metallic", properties);
                specColor = CustomBaseShaderGUI.FindProperty("_SpecColor", properties, false);
                metallicGlossMap = CustomBaseShaderGUI.FindProperty("_MetallicGlossMap", properties);
                specGlossMap = CustomBaseShaderGUI.FindProperty("_SpecGlossMap", properties, false);
                smoothness = CustomBaseShaderGUI.FindProperty("_Smoothness", properties, false);
                smoothnessMapChannel = CustomBaseShaderGUI.FindProperty("_SmoothnessTextureChannel", properties, false);
                bumpMapProp = CustomBaseShaderGUI.FindProperty("_BumpMap", properties, false);
                bumpScaleProp = CustomBaseShaderGUI.FindProperty("_BumpScale", properties, false);
                parallaxMapProp = CustomBaseShaderGUI.FindProperty("_ParallaxMap", properties, false);
                parallaxScaleProp = CustomBaseShaderGUI.FindProperty("_Parallax", properties, false);
                occlusionStrength = CustomBaseShaderGUI.FindProperty("_OcclusionStrength", properties, false);
                occlusionMap = CustomBaseShaderGUI.FindProperty("_OcclusionMap", properties, false);
                // Advanced Props
                highlights = CustomBaseShaderGUI.FindProperty("_SpecularHighlights", properties, false);
                reflections = CustomBaseShaderGUI.FindProperty("_EnvironmentReflections", properties, false);

                clearCoat           = CustomBaseShaderGUI.FindProperty("_ClearCoat", properties, false);
                clearCoatMap        = CustomBaseShaderGUI.FindProperty("_ClearCoatMap", properties, false);
                clearCoatMask       = CustomBaseShaderGUI.FindProperty("_ClearCoatMask", properties, false);
                clearCoatSmoothness = CustomBaseShaderGUI.FindProperty("_ClearCoatSmoothness", properties, false);
            }
        }
        ...
        public static void Inputs(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            CustomBaseShaderGUI.DrawNormalArea(materialEditor, properties.bumpMapProp, properties.bumpScaleProp);
        ...
        public static void DoMetallicSpecularArea(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            else
            {
                ...
                CustomBaseShaderGUI.TextureColorProps(materialEditor, Styles.specularMapText, properties.specGlossMap,
        ...
        {
            var opaque = ((CustomBaseShaderGUI.SurfaceType) material.GetFloat("_Surface") ==
                          CustomBaseShaderGUI.SurfaceType.Opaque);
            EditorGUI.indentLevel++;
            EditorGUI.BeginChangeCheck();
        ...
        public static void SetMaterialKeywords(Material material)
        {
            ...
            CoreUtils.SetKeyword(material, "_MinDistanceDissolve", true);
            CoreUtils.SetKeyword(material, "_MaxDistanceDissolve", true);
